...
if __name__=='__main__':
    ...
    for i in range(len(k['frames'])):
        k['kangle_l'][i]=180-tools.angle((k['x_lak'][i],k['y_lak'][i],k['z_lak'][i]),(k['x_lkn'][i],k['y_lkn'][i],k['z_lkn'][i]),(k['x_las'][i],k['y_las'][i],k['z_las'][i]), True)
        k['kangle_r'][i]=180-tools.angle((k['x_rak'][i],k['y_rak'][i],k['z_rak'][i]),(k['x_rkn'][i],k['y_rkn'][i],k['z_rkn'][i]),(k['x_ras'][i],k['y_ras'][i],k['z_ras'][i]), True) 
    fig3=plt.figure()
