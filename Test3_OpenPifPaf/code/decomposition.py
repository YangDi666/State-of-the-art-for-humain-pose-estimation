...
ax1.scatter(gt['frame'], -gt['Y_lak'], marker='.')
...
ax1.scatter(gt['frame'], -gt['Y_rak'], marker='.')
...
ax1.scatter(kk['frames'], kk['z_rak'], marker='.')
ax1.plot(kk['frames'], kk['z_rak'], color='orange', lw=0.2,label='right')

ax1.scatter(kk['frames'], kk['z_lak'], marker='.')
...
ax3.scatter(kk['frames'], kk['kangle_l'])
ax3.plot(kk['frames'], kk['kangle_l'], color='b')
ax3.scatter(gt['frame'], gt['X_lag'], marker='.')
...
if direction=='back':
    kk.to_csv('testVideos'+'/test'+nb_video+'/'+number+'_PifPaf_joints_3DKinect_back.csv',encoding='gbk')
else:
    kk.to_csv('testVideos'+'/test'+nb_video+'/'+number+'_PifPaf_joints_3DKinect_front.csv',encoding='gbk')
