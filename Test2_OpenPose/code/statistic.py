...
with open('testVideos/test1/space_recalage.json') as json_data:
        #with open('testVedios/test'+nb_video+'/time_recalage.json') as json_data:
        jsondata1 = json.load(json_data)
with open('testVideos/test2/space_recalage.json') as json_data:
        #with open('testVedios/test'+nb_video+'/time_recalage.json') as json_data:
        jsondata2 = json.load(json_data)
with open('testVideos/test3/space_recalage.json') as json_data:
        #with open('testVedios/test'+nb_video+'/time_recalage.json') as json_data:
        jsondata3 = json.load(json_data)
with open('testVideos/test16/space_recalage.json') as json_data:
        #with open('testVedios/test'+nb_video+'/time_recalage.json') as json_data:
        jsondata4 = json.load(json_data)
with open('testVideos/test18/space_recalage.json') as json_data:
        #with open('testVedios/test'+nb_video+'/time_recalage.json') as json_data:
