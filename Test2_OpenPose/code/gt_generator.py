...
data.to_csv('testVideos'+'/test'+nb_video+'/'+number+'_GT-Vicon_OpenPose_3DKinect_'+direction+'_respectiveTF.csv', encoding='gbk')
...
data.to_csv('testVideos'+'/test'+nb_video+'/'+number+'_GT-Vicon_OpenPose_3DKinect_'+direction+'_generalTF.csv', encoding='gbk')
...
data.to_csv('testVideos'+'/test'+nb_video+'/'+number+'_GT-Vicon_OpenPose_2DColor_'+direction+'_respectiveTF.csv', encoding='gbk')
...
data.to_csv('testVideos'+'/test'+nb_video+'/'+number+'_GT-Vicon_OpenPose_2DColor_'+direction+'_generalTF.csv', encoding='gbk')
