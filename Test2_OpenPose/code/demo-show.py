...
def get_bones(njts):
    bones = {}
    if njts==18:
        bones['left']  = [(12,13),(11,12),(1,11),(1,2),(0,7),(7,15),(1,5),(5,6),(6,7)] # bones on the left
        bones['right'] = [(10,9),(9,8),(8,1),(0,16),(16,14),(1,2),(2,3),(3,4)] # bones on the right
...
def demo( imagename):
    ...
    with open(imagename[:-4]+'.json') as json_data:
