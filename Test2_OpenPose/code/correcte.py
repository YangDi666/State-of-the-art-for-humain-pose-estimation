...
if __name__=='__main__':
    ...
    ax1.plot(k['frames'], k['y_lak'], marker='.', color='orange', lw=0.2)
    ax1.plot(k['frames'], k['y_rak'], marker='.', color='y', lw=0.2)
    ...
    '''
    ax1.plot(k['frames'], k['y_lak'], marker='.', color='b', lw=0.2)
    ax1.plot(k['frames'], k['y_rak'], marker='.', color='r', lw=0.2)
    ...
    ax4.plot(k['frames'], k['y_las'], marker='.', color='orange', lw=0.2)
    ax4.plot(k['frames'], k['y_ras'], marker='.', color='y', lw=0.2)
    ...
    ax4.plot(k['frames'], k['y_las'], marker='.', color='b', lw=0.2)
    ax4.plot(k['frames'], k['y_ras'], marker='.', color='r', lw=0.2)
    ax4.set_title('z\' of AS_kinect')

    # show original kn dis            
    fig3=plt.figure()
    ax5=fig3.add_subplot(111)
    ax5.plot(k['frames'], k['y_lkn'], marker='.', color='orange', lw=0.2)
    ax5.plot(k['frames'], k['y_rkn'], marker='.', color='y', lw=0.2)
